...
$banner1Query = mysqli_query($db, "SELECT * FROM imgs WHERE imgClass='banner1' AND imgFile='1'") or die(mysqli_error($db));
$banner1 = mysqli_num_rows($banner1Query);

$banner2Query = mysqli_query($db, "SELECT * FROM imgs WHERE imgClass='banner2' AND imgFile='2'") or die(mysqli_error($db));
$banner2 = mysqli_num_rows($banner2Query);

$banner3Query = mysqli_query($db, "SELECT * FROM imgs WHERE imgClass='banner3' AND imgFile='3'") or die(mysqli_error($db));
$banner3 = mysqli_num_rows($banner3Query);

  
echo    "<div class='mySlides fade'>";
        if ($banner1 == '1'){
echo     "<img src='img/banner1.jpg' style='width:100%; height: auto;' id='banner1'>";
        } else { echo "<img src='img/defBanner.JPG' style='width:100%; height: auto;'>"; }
echo     "</div>";
echo      "<div class='mySlides fade'>";
        if ($banner2 == '1'){
echo      "<img src='img/banner2.jpg' style='width:100%' id='banner2'>";
        } else { echo "<img src='img/defBanner.JPG' style='width:100%; height: auto;'>"; }
echo      "</div>";
echo      "<div class='mySlides fade'>";
        if ($banner3 == '1'){
echo      "<img src='img/banner3.jpg' style='width:100%' id='banner3'>";
        } else { echo "<img src='img/defBanner.JPG' style='width:100%; height: auto;'>"; }
echo      "</div>";
// }
