...
if (isset($_REQUEST['fname'], $_REQUEST['mname'], $_REQUEST['lname'], $_REQUEST['idNum'], $_REQUEST['position'], $_REQUEST['Num'], $_REQUEST['bday'], $_REQUEST['gender'], $_REQUEST['username'], $_REQUEST['password'], $_REQUEST['passwordConfirm'])){
    ...
    $insertQuery = mysqli_query($db, "INSERT INTO profiles (employeeId, username, password, defPassword, fname, mname, lname, bday, position, contactNum) VALUES ('$idNum', '$username','','$password', '$fname', '$mname', '$lname', '$bday', '$position', '$Num')") or die(mysqli_error($db));
...
$banner4 = mysqli_num_rows($banner4Query);
   ...
   if ($banner4 == '1'){
      echo   "<img src='img/brgylogo.png' id='brgyLogo'>";
    } else { echo   "<img src='img/defLogo.png' id='brgyLogo'>"; }
?>
<br>
