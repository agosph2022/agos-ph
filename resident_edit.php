...
$banner4 = mysqli_num_rows($banner4Query);
   ...
   if ($banner4 == '1'){
      echo   "<img src='img/brgylogo.png' id='imgBanner' style='float: left; left: 30px; margin-left: 10%; position: relative; width: 100%;'>";
    } else { echo   "<img src='img/defLogo.png' id='imgBanner' style='float: left; left: 30px; margin-left: 10%; position: relative; width: 100%;'>"; }
?>
        <br>
        </div><br>
      </div>
