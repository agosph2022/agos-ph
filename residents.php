...
$banner4Query = mysqli_query($db, "SELECT * FROM imgs WHERE imgClass='logo' AND imgFile='4'") or die(mysqli_error($db));
$banner4 = mysqli_num_rows($banner4Query);

   if ($banner4 == '1'){
      echo   "<img src='img/brgylogo.png' id='imgBanner'>";
    } else { echo   "<img src='img/defLogo.png' id='imgBanner'>"; }
?>
        </div>
  ...
  <div id="regSenior" style="position: absolute; top: 20px; padding: 20px; width: 50%; z-index:900; background-color:#f5f5f5; padding: 30px; border-radius:10px; margin-left: 25%; margin-right: 25%; visibility:hidden; padding-top: 15px; border-radius:4px;">
    <form id="" method="post" action="residents_add.php">
          ...
          <!--<form action="">-->
              ...
              <input type="date" class="form-date" id="birthday" name="birthday" required style="height: 35px; width: 203px; font-size: 100%;border-radius: 5px; border: 1px lightgray solid; margin-left: 7px;" max=<?php echo date("Y-m-d", strtotime("-21900 days"));?>><br>
      ...
      <div id="regChild" style="position: absolute; top: 20px; padding: 20px; width: 50%; z-index:900; background-color:#f5f5f5; padding: 30px; border-radius:10px; margin-left: 25%; margin-right: 25%; visibility:hidden;padding-top: 15px; border-radius:4px;">
        <form id="" method="post" action="residents_add.php">
          ...
          <!--<form action="">-->
              ...
              <label for="birthday">&nbsp;&nbsp;Birthday:</label>
              <input type="date" class="form-date" id="birthday" name="birthday" required style="height: 35px; width: 203px; font-size: 100%;border-radius: 5px; border: 1px lightgray solid; margin-left: 7px;"  min="<?php echo date('Y-m-d', strtotime('-2555 days'));?>" max="<?php echo date('Y-m-d', strtotime('-365 days'));?>"><br>
      ...
      <div id="regInfant" style="position: absolute; top: 20px; padding: 20px; width: 50%; z-index:900; background-color:#f5f5f5; padding: 30px; border-radius:10px; margin-left: 25%; margin-right: 25%; visibility:hidden;padding-top: 15px; border-radius:4px;">
        <form id="" method="post" action="residents_add.php">
          ...
          <!--<form action="">-->
              ...
              <label for="birthday">&nbsp;&nbsp;Birthday:</label>
              <input type="date" class="form-date" id="birthday" name="birthday" required style="height: 35px; width: 203px; font-size: 100%;border-radius: 5px; border: 1px lightgray solid; margin-left: 7px;" min="<?php echo date('Y-m-d', strtotime('-364 days'));?>" max="<?php echo date('Y-m-d'); ?>"><br>
