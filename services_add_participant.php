...
if (isset($_REQUEST['addId'], $_REQUEST['eventId'], $_REQUEST['eventName'], $_REQUEST['addAge'], $_REQUEST['addName'], $_REQUEST['addGuardian'], $_REQUEST['addNum'], $_REQUEST['eventAddress'])){
    ...
    $query = "INSERT INTO eventparticipants (eventId, addId, eventName, eventAddress, addName, addAge, addDisability, addGuardian, addNum, addBy, updatedBy)  VALUES ('$eventId', '$addId', '$eventName', '$eventAddress','$addName', '$addAge', '','$addGuardian', '$addNum', '".$_SESSION['username']."','')";
